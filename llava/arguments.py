...
class ModelArguments:
    ...
    pooling_strategy: Optional[str] = field(default="coarse_to_fine")
...
@dataclass
class DataArguments:
    train_data_path: str = field(default=None, metadata={"help": "Path to the training data, in llava's instruction.json format. Supporting multiple json files via /path/to/{a,b,c}.json"})
    ...
    img_data_augmentation: bool = False
    pcd_data_augmentation: bool = False
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    grounding_head_lr: Optional[float] = None
    discrim_head_lr: Optional[float] = None
